...
import            Auth from './container    s       /Auth/Auth'
import Logout from        './co   ntainers/Auth/Logout/Logout'
...
import *          as
actions                 from './store/     actions/index'
...
class App extends Co   mponent {

  componentDidMoudnt () {
    this.props.on       TryAuto               Signup();
  }
